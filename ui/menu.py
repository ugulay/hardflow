...
_EDIT_ITEMS = (
    ...
    ("object.hardflow_fix_shading", "Fix Boolean Shading", 'NODE_MATERIAL', {}),
    ("object.hardflow_sort_modifiers", "Sort Modifier Stack", 'SORTSIZE', {}),
    None,
...
_DISPLAY_ITEMS = (
    ...
    ("object.hardflow_display_toggle", "Cutters", 'MOD_BOOLEAN',
     {'mode': 'CUTTERS'}),
    ("object.hardflow_cutter_scroll", "Cutter Scroll", 'LOOP_FORWARDS', {}),
    None,
