...
footprint knife as the fallback). Code is syntax-verified with pure + headless
tests (62 pure + 91 headless); the new bpy paths are live-verified in Blender
5.1.2, and full GUI verification of the modal interactions is tracked in
`tests/manual_checklist.md`. Roadmap: `ROADMAP.md`.
