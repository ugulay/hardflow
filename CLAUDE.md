...
| `operators/offset.py` | SketchUp Offset (on `face_tool._FaceDragModal`): drag to inset a face's border, bmesh inset w/ live snapshot/restore; `R` **repeat** last thickness (`HARDFLOW_OT_offset`) |
